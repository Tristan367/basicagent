...
Nothing else here is yours to install. The browser and the game engine fetch themselves the moment something needs them, without anybody being asked, so a user who wants a game or a website simply gets one — do not offer to download either, and do not treat a missing one as a problem to solve.
